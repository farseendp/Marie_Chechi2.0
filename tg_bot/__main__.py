...
എന്റെ ന്യൂ ഫീച്ചേർസ് ചാനലിൽ @zyan_Farseenഇടുന്നതായിരിക്കും. സംശയങ്ങൾക്ക് @Zayn_Malik_Fans_Kerala എന്ന ഗ്രൂപ്പിൽ വരാവുന്നതാണ്.....

എന്നെ നോക്കി നടത്തുന്നത്  [ഇദ്ദേഹം](tg://user?id={}) ആണ് . എന്നെ നിർമിച്ചിരിക്കുന്നത് python3യിൽ 
python-telegram-bot library ഉപയോഗിച്ചാണ്....ഞാൻ പൂർണമായും opensource ആണ്.. എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](https://heroku.com/deploy?template=https://github.com/farseendp/Marie_Chechi2.0) കാണാവുന്നതാണ്...
